...
@implementation LeDataCenterExend (test)
...
{
    LeRequestItem *requestItem = [[LeRequestItem alloc] init];
...
-(void)parseVideoBlockListData:(LeResponseItem *)item
{
